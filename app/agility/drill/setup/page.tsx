    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Configure Your Drill</h1>
          <p className="text-gray-600">Select a course and customize your training session</p>
        </header>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-sm mb-3">{course.cone_count} cones · {course.description}</p>
                      <CourseMap course={course} compact className="w-48 h-48" />
                    </div>
                    {course.is_official && (
                      <span className="px-3 py-1 bg-indigo-600 text-white text-xs font-bold rounded-full">RANKED</span>
                    )}
                  </div>
                </button>
              ))}
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Drill Settings</h2>
            ...
            <button onClick={startDrill} disabled={!selectedCourse}
              className="w-full mt-6 py-4 bg-indigo-600 text-white text-xl font-bold rounded-xl hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition">
              START DRILL
            </button>
          </section>
        </div>
